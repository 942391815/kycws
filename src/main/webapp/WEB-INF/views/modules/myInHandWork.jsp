...
<body onload="setUser()">
	<ul class="nav nav-tabs">
		<li ${subType=='1' ?"class='active'":''}><a href="${ctx}/myInHandWork?subType=1">自媒体任务</a></li>
		<li ${subType=='2' ?"class='active'":''}><a href="${ctx}/myInHandWork?subType=2">企业任务</a></li>
		<li ${subType=='3' ?"class='active'":''}><a href="${ctx}/myInHandWork?subType=3">品牌任务</a></li>
	</ul>
	...
	<display:table name="page.list" pagesize="${page.pageSize}" requestURI="${ctx}/mywork" id="table" sort="external"
		...
		<display:column property="updateTime" title="保存时间" sortable="false"/>
		<display:column title="操作">
			<a href="${ctx}/backInfo/detail?bid=${table.bid}&subType=${subType}">处理</a>
		</display:column>
    </display:table>
