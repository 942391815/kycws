...
<ul class="nav nav-tabs">
    <ul class="nav nav-tabs">
        <li ${subType=='1' ?"class='active'":''}><a href="${ctx}/mySubmitWork?subType=1">自媒体任务</a></li>
        <li ${subType=='2' ?"class='active'":''}><a href="${ctx}/mySubmitWork?subType=2">企业任务</a></li>
        <li ${subType=='3' ?"class='active'":''}><a href="${ctx}/mySubmitWork?subType=3">品牌任务</a></li>
    </ul>
</ul>
...
<display:table name="page.list" pagesize="${page.pageSize}" requestURI="${ctx}/mywork" id="table" sort="external"
    ...
    <display:column title="操作">
        <a href="${ctx}/backInfo/subDetail?bid=${table.bid}&subType=${subType}">详情</a>
    </display:column>
</display:table>
