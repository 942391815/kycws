...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
        ...
        <xsl:otherwise>
          ...
          <xsl:choose>
            ...
            <xsl:otherwise>
              ...
              <xsl:attribute name="onmouseover">adf.Utils.getEventSource(event).className = 'esriToolHover';</xsl:attribute>
              <xsl:attribute name="onmousedown">adf.Utils.getEventSource(event).className = 'esriToolSelected';</xsl:attribute>
              <xsl:attribute name="onclick">adf.Controls.maps['<xsl:value-of select="//map-id"/>'].createCurrentToolItem('<xsl:value-of select="$taskActionId"/>', 'button_<xsl:value-of select="$taskActionId" />', 'adf.MapServerAction', <xsl:value-of select="$actionNode/action-properties/@show-loading-image"/>, <xsl:value-of select="//client-post-back"/>, null, null, 'esriToolDefault', 'esriToolHover', 'esriToolSelected', 'esriToolDisabled'); return false;</xsl:attribute>
              <xsl:attribute name="onmouseout">adf.Utils.getEventSource(event).className = 'esriToolDefault';</xsl:attribute>
            </xsl:otherwise>
          </xsl:choose>
        </xsl:otherwise>
      </xsl:choose>
  ...
  <xsl:template name="gpDataFile">
    ...
    <xsl:element name="a">
      ...
      <xsl:attribute name="onclick">adf.UploadUtil.showUploadWindow('<xsl:value-of select="$openLabel" />', esriGpDataFileHandler<xsl:value-of select="$paramName" />);</xsl:attribute>
        ...
        <xsl:element name="td"> <!-- Column Two -->
          ...
          <xsl:choose>
            <xsl:when test="$addRecordToolCnt > 0">
              ...
              <xsl:choose>
                <xsl:when test="$toolNode/tool-properties/@client-action = 'adf.MapPoint'">
                  <xsl:element name="input"> <!-- Input Start -->
                    <xsl:attribute name="name">button_<xsl:value-of select="$taskToolId"/></xsl:attribute>
                    <xsl:attribute name="id">button_<xsl:value-of select="$taskToolId"/></xsl:attribute>
                    <xsl:attribute name="type">IMAGE</xsl:attribute>
                    ...
                    <xsl:choose>
                      ...
                      <xsl:otherwise>
                        ...
                        <xsl:attribute name="onmouseover">adf.Utils.getEventSource(event).src = 'images/tasks/geoprocessing/gpPointU.gif';</xsl:attribute>
                        <xsl:attribute name="onmousedown">adf.Utils.getEventSource(event).src = 'images/tasks/geoprocessing/gpPointD.gif';</xsl:attribute>
                        <xsl:attribute name="onmouseout">adf.Utils.getEventSource(event).src = 'images/tasks/geoprocessing/gpPoint.gif';</xsl:attribute>
                        <xsl:attribute name="onclick">adf.Controls.maps['<xsl:value-of select="//map-id"/>'].createCurrentToolItem('<xsl:value-of select="$taskToolId"/>', 'button_<xsl:value-of select="$taskToolId"/>', '<xsl:value-of select="$toolNode/tool-properties/@client-action"/>', true, <xsl:value-of select="//client-post-back"/>, '#FF0000', 2, 'images/tasks/geoprocessing/gpPoint.gif', 'images/tasks/geoprocessing/gpPointU.gif', 'images/tasks/geoprocessing/gpPointD.gif', 'images/tasks/geoprocessing/gpPointX.gif'); return false;</xsl:attribute>
                      </xsl:otherwise>
                    </xsl:choose>
                  </xsl:element> <!-- Input End -->
                </xsl:when>
                <xsl:when test="$toolNode/tool-properties/@client-action = 'adf.MapPolyline'">
                  <xsl:element name="input"> <!-- Input Start -->
                    <xsl:attribute name="name">button_<xsl:value-of select="$taskToolId"/></xsl:attribute>
                    <xsl:attribute name="id">button_<xsl:value-of select="$taskToolId"/></xsl:attribute>
                    <xsl:attribute name="type">IMAGE</xsl:attribute>
                    ...
                    <xsl:choose>
                      ...
                      <xsl:otherwise>
                        ...
                        <xsl:attribute name="onmouseover">adf.Utils.getEventSource(event).src = 'images/tasks/geoprocessing/gpPolylineU.gif';</xsl:attribute>
                        <xsl:attribute name="onmousedown">adf.Utils.getEventSource(event).src = 'images/tasks/geoprocessing/gpPolylineD.gif';</xsl:attribute>
                        <xsl:attribute name="onmouseout">adf.Utils.getEventSource(event).src = 'images/tasks/geoprocessing/gpPolyline.gif';</xsl:attribute>
                ...
                <xsl:when test="$toolNode/tool-properties/@client-action = 'adf.MapPolygon'">
                  <xsl:element name="input"> <!-- Input Start -->
                    <xsl:attribute name="name">button_<xsl:value-of select="$taskToolId"/></xsl:attribute>
                    <xsl:attribute name="id">button_<xsl:value-of select="$taskToolId"/></xsl:attribute>
                    <xsl:attribute name="type">IMAGE</xsl:attribute>
                    ...
                    <xsl:choose>
                      ...
                      <xsl:otherwise>
                        ...
                        <xsl:attribute name="onmouseover">adf.Utils.getEventSource(event).src = 'images/tasks/geoprocessing/gpPolygonU.gif';</xsl:attribute>
                        <xsl:attribute name="onmousedown">adf.Utils.getEventSource(event).src = 'images/tasks/geoprocessing/gpPolygonD.gif';</xsl:attribute>
                        <xsl:attribute name="onmouseout">adf.Utils.getEventSource(event).src = 'images/tasks/geoprocessing/gpPolygon.gif';</xsl:attribute>
              ...
              <xsl:element name="input">
                ...
                <xsl:choose>
                  ...
                  <xsl:otherwise>
                    ...
                    <xsl:attribute name="onmouseover">adf.Utils.getEventSource(event).src = 'images/tasks/geoprocessing/gpAddU.gif';</xsl:attribute>
                    <xsl:attribute name="onmousedown">adf.Utils.getEventSource(event).src = 'images/tasks/geoprocessing/gpAddD.gif';</xsl:attribute>
                    <xsl:attribute name="onmouseout">adf.Utils.getEventSource(event).src = 'images/tasks/geoprocessing/gpAdd.gif';</xsl:attribute>
                    <xsl:attribute name="onclick">adf.Controls.maps['<xsl:value-of select="//map-id"/>'].createCurrentToolItem('<xsl:value-of select="$taskActionId5"/>', 'button_<xsl:value-of select="$taskActionId5" />', 'adf.MapServerAction', true, <xsl:value-of select="//client-post-back"/>, null, null, 'images/tasks/geoprocessing/gpAdd.gif', 'images/tasks/geoprocessing/gpAddU.gif', 'images/tasks/geoprocessing/gpAddD.gif', 'images/tasks/geoprocessing/gpAddX.gif'); return false;</xsl:attribute>
                  </xsl:otherwise>
                </xsl:choose>
              </xsl:element>
            </xsl:when>
          ...
          <xsl:element name="input">
            ...
            <xsl:choose>
              ...
              <xsl:otherwise>
                ...
                <xsl:attribute name="onmouseover">adf.Utils.getEventSource(event).src = 'images/tasks/geoprocessing/gpEditAttributesU.gif';</xsl:attribute>
                <xsl:attribute name="onmousedown">adf.Utils.getEventSource(event).src = 'images/tasks/geoprocessing/gpEditAttributesD.gif';</xsl:attribute>
                <xsl:attribute name="onmouseout">adf.Utils.getEventSource(event).src = 'images/tasks/geoprocessing/gpEditAttributes.gif';</xsl:attribute>
                <xsl:choose>
                  <xsl:when test="//show-in-window = 'true'">
                    <xsl:attribute name="onclick">if (!document.getElementById('<xsl:value-of select="$multiSelectId" />').value) document.getElementById('<xsl:value-of select="$multiSelectId" />').value = 1;<xsl:value-of select="$winMgr"/>.windows['<xsl:value-of select="$winFeaturesIdPrefix"/>_<xsl:value-of select="@name" />'].show(); adf.Controls.maps['<xsl:value-of select="//map-id"/>'].createCurrentToolItem('<xsl:value-of select="$taskActionId1"/>', 'button_<xsl:value-of select="$taskActionId1" />', 'adf.MapServerAction', true, <xsl:value-of select="//client-post-back"/>, null, null, 'images/tasks/geoprocessing/gpEditAttributes.gif', 'images/tasks/geoprocessing/gpEditAttributesU.gif', 'images/tasks/geoprocessing/gpEditAttributesD.gif', 'images/tasks/geoprocessing/gpEditAttributesX.gif'); return false;</xsl:attribute>
                  </xsl:when>
                  <xsl:otherwise>
                    <xsl:attribute name="onclick">if (!document.getElementById('<xsl:value-of select="$multiSelectId" />').value) document.getElementById('<xsl:value-of select="$multiSelectId" />').value = 1; adf.Controls.maps['<xsl:value-of select="//map-id"/>'].createCurrentToolItem('<xsl:value-of select="$taskActionId1"/>', 'button_<xsl:value-of select="$taskActionId1" />', 'adf.MapServerAction', true, <xsl:value-of select="//client-post-back"/>, null, null, 'images/tasks/geoprocessing/gpEditAttributes.gif', 'images/tasks/geoprocessing/gpEditAttributesU.gif', 'images/tasks/geoprocessing/gpEditAttributesD.gif', 'images/tasks/geoprocessing/gpEditAttributesX.gif'); return false;</xsl:attribute>
                  </xsl:otherwise>
                </xsl:choose>
              </xsl:otherwise>
            </xsl:choose>
          ...
          <xsl:element name="input">
            ...
            <xsl:choose>
              ...
              <xsl:otherwise>
                ...
                <xsl:attribute name="onmouseover">adf.Utils.getEventSource(event).src = 'images/tasks/geoprocessing/gpDeleteU.gif';</xsl:attribute>
                <xsl:attribute name="onmousedown">adf.Utils.getEventSource(event).src = 'images/tasks/geoprocessing/gpDeleteD.gif';</xsl:attribute>
                <xsl:attribute name="onmouseout">adf.Utils.getEventSource(event).src = 'images/tasks/geoprocessing/gpDelete.gif';</xsl:attribute>
                <xsl:attribute name="onclick">adf.Controls.maps['<xsl:value-of select="//map-id"/>'].createCurrentToolItem('<xsl:value-of select="$taskActionId2"/>', 'button_<xsl:value-of select="$taskActionId2" />', 'adf.MapServerAction', true, <xsl:value-of select="//client-post-back"/>, null, null, 'images/tasks/geoprocessing/gpDelete.gif', 'images/tasks/geoprocessing/gpDeleteU.gif', 'images/tasks/geoprocessing/gpDeleteD.gif', 'images/tasks/geoprocessing/gpDeleteX.gif'); return false;</xsl:attribute>
              </xsl:otherwise>
            </xsl:choose>
          </xsl:element>
        </xsl:element>
									...
									<xsl:choose>
										<xsl:when test="count(domain) > 0">
											<xsl:element name="select">
												...
												<xsl:for-each select="domain/coded-value">
													<xsl:element name="option">
														<xsl:attribute name="value"><xsl:value-of select="@value"/></xsl:attribute>
          ...
          <xsl:element name="input"> <!-- Input Element Start -->
            ...
            <xsl:choose>
              ...
              <xsl:otherwise>
                ...
                <xsl:choose>
                  <xsl:when test="//show-in-window = 'true'">
                    <xsl:attribute name="onclick"><xsl:value-of select="$winMgr"/>.windows['<xsl:value-of select="$winFeaturesIdPrefix"/>_<xsl:value-of select="$taskParamName" />'].hide(); adf.Controls.maps['<xsl:value-of select="//map-id"/>'].createCurrentToolItem('<xsl:value-of select="$taskActionId3"/>', 'button_<xsl:value-of select="$taskActionId3" />', 'adf.MapServerAction', true, <xsl:value-of select="//client-post-back"/>, null,   null, 'esriToolDefault', 'esriToolHover', 'esriToolSelected', 'esriToolDisabled'); return false;</xsl:attribute>
                  </xsl:when>
                  <xsl:otherwise>
                    <xsl:attribute name="onclick">adf.Controls.maps['<xsl:value-of select="//map-id"/>'].createCurrentToolItem('<xsl:value-of select="$taskActionId3"/>', 'button_<xsl:value-of select="$taskActionId3" />', 'adf.MapServerAction', true, <xsl:value-of select="//client-post-back"/>, null,   null, 'esriToolDefault', 'esriToolHover', 'esriToolSelected', 'esriToolDisabled'); return false;</xsl:attribute>
                  </xsl:otherwise>
                </xsl:choose>
          ...
          <xsl:element name="input">
            ...
            <xsl:choose>
              ...
              <xsl:otherwise>
                ...
                <xsl:choose>
                  <xsl:when test="//show-in-window = 'true'">
                    <xsl:attribute name="onclick"><xsl:value-of select="$winMgr"/>.windows['<xsl:value-of select="$winFeaturesIdPrefix"/>_<xsl:value-of select="$taskParamName" />'].hide(); adf.Controls.maps['<xsl:value-of select="//map-id"/>'].createCurrentToolItem('<xsl:value-of select="$taskActionId4"/>', 'button_<xsl:value-of select="$taskActionId4" />', 'adf.MapServerAction', true, <xsl:value-of select="//client-post-back"/>, null, null, 'esriToolDefault', 'esriToolHover', 'esriToolSelected', 'esriToolDisabled');return false;</xsl:attribute>
                  </xsl:when>
                  <xsl:otherwise>
                    <xsl:attribute name="onclick">adf.Controls.maps['<xsl:value-of select="//map-id"/>'].createCurrentToolItem('<xsl:value-of select="$taskActionId4"/>', 'button_<xsl:value-of select="$taskActionId4" />', 'adf.MapServerAction', true, <xsl:value-of select="//client-post-back"/>, null, null, 'esriToolDefault', 'esriToolHover', 'esriToolSelected', 'esriToolDisabled');return false;</xsl:attribute>
                  </xsl:otherwise>
                </xsl:choose>
                <xsl:attribute name="onmouseout">adf.Utils.getEventSource(event).className = 'esriToolDefault';</xsl:attribute>
              </xsl:otherwise>
