                ...
                <xsl:when test="$actionNode/action-properties/@renderer-type = 'IMAGEONLY'">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            ...
                            <xsl:attribute name="onclick">adf.Controls.maps['<xsl:value-of select="//map-id"/>'].createCurrentToolItem('<xsl:value-of select="$taskActionId"/>', 'button_<xsl:value-of select="$taskActionId" />', 'adf.MapServerAction', <xsl:value-of select="$actionNode/action-properties/@show-loading-image"/>, <xsl:value-of select="//client-post-back"/>, null, null, '<xsl:value-of select="$contextpath" /><xsl:value-of select="$actionNode/action-properties/@default-image"/>', '<xsl:value-of select="$contextpath" /><xsl:value-of select="$actionNode/action-properties/@hover-image"/>', '<xsl:value-of select="$contextpath" /><xsl:value-of select="$actionNode/action-properties/@selected-image"/>', '<xsl:value-of select="$contextpath" /><xsl:value-of select="$actionNode/action-properties/@disabled-image"/>'); return false;
                            </xsl:attribute>
                ...
                <xsl:otherwise>
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            ...
                            <xsl:attribute name="onclick">adf.PrintTask.createPrintMap('<xsl:value-of select="$taskId"/>','<xsl:value-of select="//map-id"/>','<xsl:value-of select="$taskActionId"/>', <xsl:value-of select="$actionNode/action-properties/@show-loading-image"/>, <xsl:value-of select="//client-post-back"/>)</xsl:attribute>                       
                            <!--
                                ...
                                <xsl:otherwise>
                                    <xsl:for-each select="$paramNode/select/option">   
                                        <xsl:element name="input">
                                            ...
                                            <xsl:attribute name="onclick">adf.PrintTask.resultChecked(<xsl:value-of select="$taskId"/>_param_<xsl:value-of select="$paramNode/@name"/>);</xsl:attribute>
