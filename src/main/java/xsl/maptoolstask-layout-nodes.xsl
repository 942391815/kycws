        ...
        <xsl:when test="$actionNode/action-properties/@renderer-type = 'IMAGEONLY'">
          ...
          <xsl:choose>
            <xsl:when test="$actionNode/action-properties/@disabled = 'true'">
              ...
              <xsl:attribute name="onload">adf.Utils.onHandleImage(this, '<xsl:value-of select="$contextpath" /><xsl:value-of select="$actionNode/action-properties/@disabled-image"/>');</xsl:attribute>
            ...
            <xsl:otherwise>
              ...
              <xsl:attribute name="onload">adf.Utils.onHandleImage(this, '<xsl:value-of select="$contextpath" /><xsl:value-of select="$actionNode/action-properties/@default-image"/>');</xsl:attribute>
              <xsl:attribute name="onmouseover">adf.Utils.onHandleImage(this, '<xsl:value-of select="$contextpath" /><xsl:value-of select="$actionNode/action-properties/@hover-image"/>');</xsl:attribute>
              <xsl:attribute name="onmousedown">adf.Utils.onHandleImage(this, '<xsl:value-of select="$contextpath" /><xsl:value-of select="$actionNode/action-properties/@selected-image"/>');</xsl:attribute>
              ...
              <xsl:attribute name="onmouseout">adf.Utils.onHandleImage(this, '<xsl:value-of select="$contextpath" /><xsl:value-of select="$actionNode/action-properties/@default-image"/>');</xsl:attribute>
            </xsl:otherwise>
          </xsl:choose>
        </xsl:when>
        <xsl:otherwise>
        ...
        <xsl:when test="$toolNode/tool-properties/@renderer-type = 'IMAGEONLY'">
          ...
          <xsl:choose>
            <xsl:when test="$toolNode/tool-properties/@disabled = 'true'">
              ...
              <xsl:attribute name="onload">adf.Utils.onHandleImage(this, '<xsl:value-of select="$contextpath" /><xsl:value-of select="$toolNode/tool-properties/@disabled-image"/>');</xsl:attribute>
              <xsl:attribute name="style">cursor:default;</xsl:attribute>
              <xsl:attribute name="onclick">return false;</xsl:attribute>
            </xsl:when>
            <xsl:otherwise>
              <xsl:choose>
                <xsl:when test="contains(//active-tool, $taskToolId) = 'true'">
                  ...
                  <xsl:attribute name="onload">adf.Utils.onHandleImage(this, '<xsl:value-of select="$contextpath" /><xsl:value-of select="$toolNode/tool-properties/@selected-image"/>');</xsl:attribute>
                </xsl:when>
                <xsl:otherwise>
                  ...
                  <xsl:attribute name="onload">adf.Utils.onHandleImage(this, '<xsl:value-of select="$contextpath" /><xsl:value-of select="$toolNode/tool-properties/@default-image"/>');</xsl:attribute>
                </xsl:otherwise>
              </xsl:choose>
              <xsl:attribute name="onmouseover">adf.Utils.onHandleImage(this, '<xsl:value-of select="$contextpath" /><xsl:value-of select="$toolNode/tool-properties/@hover-image"/>');</xsl:attribute>
              <xsl:attribute name="onmousedown">adf.Utils.onHandleImage(this, '<xsl:value-of select="$contextpath" /><xsl:value-of select="$toolNode/tool-properties/@selected-image"/>');</xsl:attribute>
              <xsl:choose>
              ...
              <xsl:attribute name="onmouseout">adf.Utils.onHandleImage(this, '<xsl:value-of select="$contextpath" /><xsl:value-of select="$toolNode/tool-properties/@default-image"/>');</xsl:attribute>
            </xsl:otherwise>
          </xsl:choose>
        </xsl:when>
        <xsl:otherwise>
        ...
        <xsl:element name="select">
          ...
          <xsl:if test="contains($selId , 'UnitsID')">
            <xsl:attribute name="onchange">
              document.getElementById('<xsl:value-of select="$taskId"/>').value = '<xsl:value-of select="$taskId"/>';
              var p = {};
              p['<xsl:value-of select="//map-id"/>'] = '<xsl:value-of select="//map-id"/>';
              if(<xsl:value-of select="//client-post-back"/>) p.doPostBack = "doPostBack";
              adf.Utils.submitForm(adf.Controls.maps['<xsl:value-of select="//map-id"/>'].formId, <xsl:value-of select="//client-post-back"/>, adf.Controls.processPostBack, p); 
              return false;
            </xsl:attribute>
          </xsl:if>
